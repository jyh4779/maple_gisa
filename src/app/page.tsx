    ...
    <div className="space-y-16">
      ...
      <section className="text-center space-y-6 py-16">
        ...
        <p className="text-muted-foreground text-lg max-w-xl mx-auto">
          메이플플래닛 쩔기사들의 실제 이력과 사진을 확인하고, 안전하게
          쩔 서비스를 이용하세요.
        </p>
        <div className="flex gap-3 justify-center">
          <Link href="/knights">
            <Button size="lg">쩔기사 찾기</Button>
          </Link>
        ...
        <Card>
          <CardContent className="pt-6 text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              실제 쩔 완료 사진과 이력을 직접 업로드하여 신뢰도를 높여요.
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6 text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              직업, 레벨, 가격으로 조건에 맞는 쩔기사를 빠르게 찾을 수 있어요.
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6 text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              쩔기사의 캐릭터 정보, 레벨, 서비스 내역을 한눈에 확인하세요.
            </p>
          </CardContent>
        </Card>
      </section>
